...
func Main() error {
	...
	flag.StringVar(&args.Out, "out", "", "(optional) the filename that will be generated by govalid")
	...
	if args.Out == "" {
		args.Out = strings.TrimSuffix(args.In, ".go") + ".validate.go"
	}
	h, err := os.Create(args.Out)
	if err != nil {
		return fmt.Errorf("creating file: %w", err)
	}
	fmt.Fprint(h, "// Code generated by govalid. DO NOT EDIT.\n\n")
